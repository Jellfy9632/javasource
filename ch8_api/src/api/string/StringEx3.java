...
public class StringEx3 {
    public static void main(String[] args) {
        ...
        System.out.println("지정 된 문자열로 종료 여부" + str2.endsWith("요"));
        System.out.println("지정 된 문자열로 시작 여부" + str2.startsWith("요"));

        String file = " test.txt";

        // 이미지 : png or gif or jpg

        if (file.endsWith("g") || file.startsWith("g")) {
